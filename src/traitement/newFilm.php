...
if(isset($_POST['nom']) && isset($_POST['description']) && isset($_POST['duree'])){
    ...
    $banniere=(isset($_POST['banniere']))&&($_POST['banniere']!="")?$_POST['banniere']:null;
    $film = new Film($id_film, $_POST['nom'],$_POST['description'],$duree,$affiche,$genre,$age_min,$realisateur,$date_sortie,$bande_annonce,$banniere);
